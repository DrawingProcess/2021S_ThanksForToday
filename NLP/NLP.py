...
def Get_keyword(sentence):
    ...
    # ★여기 수정하기!!!!!!!!!!★
    # 30%의 핵심 단어 리스트 내에서 빈도 수 측정
    # freq_list = frequent_list(sentence, 10)     # 원문에서 빈도 수 높은 단어 최대 10개 추출
    # word_cnt = {}
    # for i, noun in enumerate(freq_list):
    #     if noun[0] in key_word_noun:
    #         if noun[0] in word_cnt.keys():
    #             word_cnt[noun[0]] += 1
    #         else:
    #             word_cnt[noun[0]] = 1
